...
if ($_SESSION['Level'] !== 'comm') {
    die("Access denied. This page is only for Committee level users.");
}
...
<head>
    ...
    <title>Committee Portal - SECL Land Outsee</title>
    <link rel="stylesheet" href="style.css">
</head>
<body style="background:#f9f9f9;">
    <?php render_nav(); ?>
    <div class="record-container">
                <h2>Records Forwarded to Committee</h2>
        ...
        <div class="table-responsive">
            <table>
                <thead>
                    <tr>
                        <th>Name</th><th>Father's Name</th><th>D.O.B</th>
                        <th>Email</th><th>Aadhar</th><th>Phone</th><th>Address</th>
                        <th>Notified Land</th><th>Acquired Land</th><th>Needed Documents</th><th>Documents</th><th>Forward To</th>
                    <th>Action</th></tr>
                </thead>
                <tbody>
                    <?php if (empty($records)): ?>
                    <tr><td colspan="15" style="text-align:center;">No records currently assigned to Committee.</td></tr>
                    <?php endif; ?>
