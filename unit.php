...
if ($_SESSION['Level'] !== 'unit') {
    die("Access denied. This page is only for Unit level users.");
}
...
<head>
    ...
    <title>Unit Portal - SECL Land Outsee</title>
...
<body style="background:#f9f9f9;">
    ...
    <?php render_nav(); ?>
        ...
        <h2>Records Assigned to Unit</h2>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="edit.php?id=<?= $row['id'] ?>" class="btn" style="background:#007bff; text-decoration:none; display:inline-block; padding: 4px 8px; font-size:12px;">Edit</a></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
