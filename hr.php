...
if ($_SESSION['Level'] !== 'HR') {
    die("Access denied. This page is only for HR level users.");
}
...
<head>
    ...
    <title>HR Portal - SECL Land Outsee</title>
    <link rel="stylesheet" href="style.css">
</head>
<body style="background:#f9f9f9;">
    <?php render_nav(); ?>
    <div class="record-container">
                <h2>Records Forwarded to HR</h2>
        ...
        <div class="table-responsive">
            <table>
                ...
                <tbody>
                    ...
                    <tr><td colspan="15" style="text-align:center;">No records currently assigned to HR.</td></tr>
                    <?php endif; ?>
